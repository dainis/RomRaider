 ...
 * sensor found. 
 */
public class VntVoltageConvertorPanel extends JDialog {
    private static final long serialVersionUID = -4785866140260703021L;
    private static final ResourceBundle rb = new ResourceUtil().getBundle(
            VntVoltageConvertorPanel.class.getName());
     ...
     * @see #getTable()
     */
    public VntVoltageConvertorPanel(
        ...
        final VntVoltageTableModel model = new VntVoltageTableModel();
